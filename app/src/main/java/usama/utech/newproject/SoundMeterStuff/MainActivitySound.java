package usama.utech.newproject.SoundMeterStuff;
...
public class MainActivitySound extends Activity {
    private static final int MY_PERMISSIONS_REQUEST_RECORD_AUDIO = 7000;
    ...
    private int MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE = 7001;
    /* Decibel */
    ...
    public void startRecord(File fFile) {
        try {
            ...
            Toast.makeText(this, "" + mRecorder.startRecorder(), Toast.LENGTH_SHORT).show();
